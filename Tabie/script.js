...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('deliveryForm').addEventListener('submit', function(event) {
        ...
        if (name && address && city && postcode && cardNumber && expiryDate && cvv) {
            ...
            //  report content on the page will be displayed
            document.getElementById('reportContent').innerText = reportContent;
            document.getElementById('reportSection').style.display = 'block';

            // downloadable file from the report content
            ...
            //message will be shown to download the report and wait for redirection
            alert('Please download your order report down below. You will be redirected to the home page in 5 minutes.');

            // cart will be cleared and redirect to the home page after a 5-minute delay
            setTimeout(() => {
